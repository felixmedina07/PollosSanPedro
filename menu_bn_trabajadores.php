            ...
            <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3 d-flex justify-content-around">
                            <a href="view/bancos-trabajadores/bnTrabAgregar.php" class="btn bc-normal ml-2">
                                Agregar Banco Trabajadores  
                            </a>
                        </div>
                        <div class="col-md-6 mb-3 d-flex justify-content-around">
                            <a href="view/bancos-trabajadores/bnTrabVer.php" class="btn bc-normal ml-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3 d-flex justify-content-around">
                        <a href="view/bancos-trabajadores/bnTrabFiltrar.php" class="btn bc-normal ml-3">
                                Filtrar Banco Trabajadores
                            </a>
                        </div>
                        <div class="col-md-6 mb-3 d-flex justify-content-around">
                        <a href="view/bancos-trabajadores/bnTrabHistorial.php" class="btn bc-normal ml-3">
                    ...
                    <div class="col-md-6 d-flex justify-content-around">
                        <a href="view/bancos-trabajadores/bnTrabEliminar.php" class="btn bc-normal ml-3">
