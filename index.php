...
<html lang="en">
<head>
<title>Pollos San Pedro - Home</title>
<meta charset="utf-8">
...
<link rel="stylesheet" type="text/css" href="portal-web/plugins/OwlCarousel2-2.2.1/owl.theme.default.css">
<link rel="stylesheet" type="text/css" href="portal-web/plugins/OwlCarousel2-2.2.1/animate.css">
<link rel="stylesheet" type="text/css" href="portal-web/plugins/slick-1.8.0/slick.css">
<link href="portal-web/plugins/icon-font/styles.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="portal-web/styles/main_styles.css">
<link rel="stylesheet" type="text/css" href="portal-web/styles/responsive.css">
</head>
...
<!--				<li class="menu_mm"><a href="blog.html">Blog</a></li>-->
	...
	<div class="home">
		<div class="home_background_container prlx_parent">
			<div class="home_background prlx" style="background-image:url(portal-web/images/slider_background.jpg)"></div>
		</div>
		...
		<div class="hero_slider_container">
			...
			<div class="hero_slider_nav_bottom">
			...
			<div class="row fill_height">
				...
				<div class="col-lg-6 v_slider_section_image">
					<div class="v_slider_image">
						<img src="portal-web/images/v_slider_section.jpg" alt="">
					</div>
				</div>
			...
			<div class="row">
				<div class="col text-center">
					<div class="section_title">
						<h1>Nos hacemos cargo de tus necesidades</h1>
	...
	<div class="cta">
		<div class="cta_background" style="background-image:url(portal-web/images/cta_background.jpg)"></div>
		
		<div class="container">
			<div class="row">
				<div class="col-lg-5 order-lg-1 order-2">
					<div class="cta_content">
						<h1>Amamos a nuestros clientes</h1>
						<p>Somos una empresa dedicada al transporte, beneficio y entrega de pollos a comercios pequeños y grandes para abastecer el 
							producto a la mayor cantidad de personas, brindado seguridad y comodidad. Contando con el personal y herramientas necesarias 
							para hacer llegar un producto de buena calidad a las puertas de nuestros clientes.</p>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-lg-5 offset-lg-2">
					<div class="text_line_content">
						<h1>Apostamos por el futuro</h1>
						<p>Trabajamos bajo un mecanismo que nos ayuda a aumentar la distribución y abastecimiento de más territorios dentro del pais 
							de manera segura, con el fin de llegar a más clientes para ofrecerles un producto de buena calidad y precio.</p>
					</div>
				</div>
			</div>
		</div>
...
<!--							<li><a href="blog.html">Blog</a></li>-->
				...
				<div class="col-lg-2">
					...
					<div class="footer_col">
						...
						<ul>
							<li><a href="portal-web/about.html#History">Historia</a></li>
							<li><a href="portal-web/about.html#Testimonials">Testimonios</a></li>
							<li><a href="portal-web/about.html#Team">Equipo</a></li>
						</ul>
					</div>
...
<script src="portal-web/js/jquery-3.2.1.min.js"></script>
<script src="portal-web/styles/bootstrap4/popper.js"></script>
<script src="portal-web/styles/bootstrap4/bootstrap.min.js"></script>
<script src="portal-web/plugins/greensock/TweenMax.min.js"></script>
<script src="portal-web/plugins/greensock/TimelineMax.min.js"></script>
<script src="portal-web/plugins/scrollmagic/ScrollMagic.min.js"></script>
<script src="portal-web/plugins/greensock/animation.gsap.min.js"></script>
<script src="portal-web/plugins/greensock/ScrollToPlugin.min.js"></script>
<script src="portal-web/plugins/slick-1.8.0/slick.js"></script>
<script src="portal-web/plugins/OwlCarousel2-2.2.1/owl.carousel.js"></script>
<script src="portal-web/plugins/scrollTo/jquery.scrollTo.min.js"></script>
<script src="portal-web/plugins/easing/easing.js"></script>
<script src="portal-web/js/custom.js"></script>
</body>
</html>