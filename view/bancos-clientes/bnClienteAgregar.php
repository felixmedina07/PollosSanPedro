...
<div class="container p-4">
    ...
    <br>
        ...
        <div class="card mb-2 sombra" style="width: 110%; height: 110%;">
            <div class="card-title mx-auto text-white text-center sombra c-banco mt-4 pt-2" style="width: 70%; height: 70%; border-radius:10px;">
                       ...
                       <div class="form-group">
                        ...
                        <div class="row mt-3 mr-4 ml-4">
                            <div class="col text-center">
                                <input  class="btn bc-banco px-8" type="submit" value="Guardar"></input>
                            </div>
                        </div>
                        </div>
                    </form>
