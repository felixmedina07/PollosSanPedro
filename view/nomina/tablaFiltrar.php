...
<br>
        <div class="mx-auto sombra" style="width: 50rem;">
          <div class="card mb-2">
            ...
            <form id="frmNomina" method="POST" action="nominaFiltrado.php"  autocomplete="off">
                            ...
                            <div class="col-12 mt-1 mb-2">
                                <select class="form-control " id="bnTrabajadorSelect" name="bnTrabajadorSelect" >
                                    ...
                                    <?php while($ver= mysqli_fetch_row($result)): ?>
                                        <option value="<?php echo $ver[1]."-".$ver[2]?>"><?php echo $ver[1]." - ".$ver[2]; ?> </option>
                                    <?php endwhile; ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-6 mt-1 mb-2">
                                <select class="form-control " id="bnCasaSelect" name="bnCasaSelect" >
                                    ...
                                    <?php 
                                        ...
                                        <option value="<?php echo $ver2[1];?>"><?php echo $ver2[1]. "-".$ver2[2]; ?></option>
                                    <?php endwhile; ?>
                                </select>
                            </div>
                            <div class="col-6 mt-1 mb-2">
                                <select class="form-control " id="bnbTrabajadorSelect" name="bnbTrabajadorSelect" >
                                    ...
                                    <?php while($ver3= mysqli_fetch_row($result3)): ?>
                                        <option value="<?php echo $ver3[1];?>"><?php echo $ver3[1]. "-".$ver3[2]." ".$ver3[3]; ?> </option>
                                    <?php endwhile; ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-group mt-3">
                       <div class="row mt-3 mr-4 ml-4">
                            <div class="col text-center">
                                <input  class="btn bc-normal px-8" type="submit" value="Buscar"></input>
                            </div>
                       </div>
                    </div>
            </form>
