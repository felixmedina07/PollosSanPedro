        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                               ...
                               <div class="col-12">
                                 <label for="">Trabajador</label>
                                    <select class="form-control" id="bnTrabajadorSelectU" name="bnTrabajadorSelectU">
                                        ...
                                        <?php
                                        $sql="SELECT cod_tra,nom_tra FROM trabajadores WHERE est_tra='A'";
                                        $result =mysqli_query($conexion,$sql);
                                        ?>
                                        <?php while($ver= mysqli_fetch_row($result)): ?>
                ...
                <div class="modal-footer">
                    <button type="button" id="btnAgregarBnTrabU" class="btn px-8 bc-cliente mx-auto" data-dismiss="modal">Actualizar</button>
                </div>
            </div>
        </div>
    </div>
